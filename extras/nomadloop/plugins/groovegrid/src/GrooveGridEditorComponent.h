...
#ifndef GROOVEGRIDPLUGINEDITOR_H
#define GROOVEGRIDPLUGINEDITOR_H
...
/**
    ...
    One or more of these is created by the GrooveGridFilter::createEditor() method,
...
class GrooveGridEditorComponent   : public AudioProcessorEditor,
...
public:
    ...
    */
    GrooveGridEditorComponent (GrooveGridFilter* const ownerFilter);

    /** Destructor. */
    ~GrooveGridEditorComponent();
    ...
    */
    ...
    GrooveGridFilter* getFilter() const throw()       { return (GrooveGridFilter*) getAudioProcessor(); }
