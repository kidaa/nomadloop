...
void GraphEditorPanel::mouseDown (const MouseEvent& e)
{
    if (e.mods.isPopupMenu())
    {
        ...
        if (mainWindow != 0)
        {
			...
			m.addSubMenu(T("Add Plugin"), pluginSubMenu);
...
//==============================================================================
GraphDocumentComponent::GraphDocumentComponent (AudioDeviceManager* deviceManager_, AudioPlayHead* playHead = 0)
    : deviceManager (deviceManager_)
{
	...
	{
		// TODO: separate checks to determine if the input is enabled as instrument or remote control
